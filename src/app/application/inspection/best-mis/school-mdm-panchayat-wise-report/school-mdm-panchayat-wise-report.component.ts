...
@Component({
  selector: 'app-school-mdm-panchayat-wise-report',
  templateUrl: './school-mdm-panchayat-wise-report.component.html',
  styleUrls: ['./school-mdm-panchayat-wise-report.component.css']
})
export class SchoolMdmPanchayatWiseReportComponent implements OnInit {
  ...
  loadDataRes(params: any) {
    ...
    this.isLoading = true;
    this.InspectionMis.mdmReportPanchayatWise(paramObj).subscribe({
      next: (res: any) => {
        console.log(res);
  ...
  getDrillDownData(
    ...
    if (level == 3) {
      this.scDistrictId = distId;
      this.scBlockId = blkId;
      this.scNagarPanchayatId = panchayatId;
      this.getSchool(panchayatId);
      this.parVal = {
        scDistrictId: distId,
        scBlockId: blkId,
        scNagarPanchayatId: panchayatId,
        schoolId: sclId,
        startDate: startDate,
        endDate: endDate,
      };
  ...
  getSchool(panchayatId: any) {
    ...
    if (panchayatId != "") {
      this.InspectionMis.getSchoolListNagarWise(panchayatId).subscribe(
        (res: any) => {
  ...
  excel(level: any) {
    ...
    this.InspectionMis.downloadMdmPanchayatCsv(
      this.csvData
    ).subscribe((res: any) => {
      const data = res["data"];
      if (level == 0) {
      ...
      new ngxCsv(data, "mdmPanchaytWiseReport", this.csvoptions);
      this.spinner.hide();
    });
  }
      ...
      this.commonService
        ...
        .subscribe((res: any) => {
          ...
          if (this.userProfile.block != 0 || this.userProfile.block != "") {
            ...
            this.getNagarPanchayat(this.userProfile.district, this.userProfile.block, 2);

...
const routes: Routes = [
  {path:"", component:GrantFundComponent, canActivate: [RoleGuard], data: {role: 'admin'} },
  {
    path: 'manageGrantType',
    component: GrantFundComponent,
    children: [
      { path: '', redirectTo: 'viewGrantType'},
      { path: 'addGrantType', component: AddGrantTypeComponent, canActivate: [RoleGuard], data: {role: 'admin'} },
      { path: 'editGrantType/:encId', component: EditGrantTypeComponent, canActivate: [RoleGuard], data: {role: 'admin'} },
      { path: 'viewGrantType', component: ViewGrantTypeComponent, canActivate: [RoleGuard], data: {role: 'view'} },
    ],
  }, 
  {
    ...
    children: [
      ...
      { path: 'addExpenditureType', component: AddExpenditureTypeComponent, canActivate: [RoleGuard], data: {role: 'admin'} },
      { path: 'editExpenditureType/:encId', component: EditExpenditureTypeComponent, canActivate: [RoleGuard], data: {role: 'admin'} },
      { path: 'viewExpenditureType', component: ViewExpenditureTypeComponent, canActivate: [RoleGuard], data: {role: 'view'} },
    ],
  }, 
  {
    ...
    children: [
      ...
      { path: 'addGrantConfiguration', component: AddGrantConfigurationComponent, canActivate: [RoleGuard], data: {role: 'admin'} },
      { path: 'editGrantConfiguration/:encId', component: EditGrantConfigurationComponent, canActivate: [RoleGuard], data: {role: 'admin'} },
      { path: 'viewGrantConfiguration', component: ViewGrantConfigurationComponent, canActivate: [RoleGuard], data: {role: 'view'} },
    ],
  },
  {
    ...
    children: [
      ...
      { path: 'addGrantInfo', component: AddGrantInfoComponent, canActivate: [RoleGuard], data: {role: 'admin'} },
      { path: 'editGrantInfo/:encId', component: EditGrantInfoComponent, canActivate: [RoleGuard], data: {role: 'admin'} },
      { path: 'viewGrantInfo', component: ViewGrantInfoComponent, canActivate: [RoleGuard], data: {role: 'view'} },
    ],
  },
  {
    ...
    children: [
      ...
      { path: 'addGrantReceive', component: AddGrantReceiveComponent, canActivate: [RoleGuard], data: {role: 'admin'} },
      { path: 'editGrantReceive/:encId', component: EditGrantReceiveComponent, canActivate: [RoleGuard], data: {role: 'admin'} },
      { path: 'viewGrantReceive', component: ViewGrantReceiveComponent, canActivate: [RoleGuard], data: {role: 'view'} },
    ],
  },
  {
    ...
    children: [
      ...
      { path: 'addGrantExpenditure', component: AddGrantExpenditureComponent, canActivate: [RoleGuard], data: {role: 'admin'} },
      { path: 'editGrantExpenditure/:encId', component: EditGrantExpenditureComponent, canActivate: [RoleGuard], data: {role: 'admin'} },
      { path: 'viewGrantExpenditure', component: ViewGrantExpenditureComponent, canActivate: [RoleGuard], data: {role: 'view'} },
      { path: 'checkBalance', component: CheckBalanceComponent, canActivate: [RoleGuard], data: {role: 'view'} },
    ],
  },
];

...
@Component({
  selector: 'app-school-inspection-report',
  templateUrl: './school-inspection-report.component.html',
  styleUrls: ['./school-inspection-report.component.css']
})
export class SchoolInspectionReportComponent implements OnInit {
  ...
  getInspectionData: any = []
  getInspectionStudentData: any = []
  getInspectionTeacherData: any = []
  getInspectionTeacherAbsentData: any = []
  getInspectionQuestion: any = []
  getInspectionAnswer: any = []
  ...
  displayedColumns: string[] = [
    "slNo",
    "district", "block", "cluster", "school", "inspectionDateTime", "action"
  ...
  loadSchoolData(...params: any) {
    ...
    this.paramVal = {
      ...
      startDate: formatDate(this.startDate, 'yyyy-MM-dd', 'en_US'),
      endDate: formatDate(this.endDate, 'yyyy-MM-dd', 'en_US'),
      serviceType: "report"
    }
    this.schoolMisService.loadSchoolInspectionReportData(this.paramVal).subscribe({
      next: (res: any) => {
  ...
  exportSchoolReport() {
    ...
    this.schoolMisService.exportSchoolInspectionDetailsReport(this.paramVal).subscribe({
      next: (res: any) => {
  ...
  toggleSearchPanel() {
    this.searchPannel = !this.searchPannel;
  }

  getInspectionDetails(inspId: any) {
    this.paramInsp = {
      inspectionId: inspId
    }
    this.spinner.show();
    this.schoolMisService.getInspectionDetails(this.paramInsp).subscribe({
      next: (res: any) => {
        this.getInspectionData = res?.getInspectionData;
        this.getInspectionStudentData = res?.getInspectionStudentData;
        this.getInspectionTeacherData = res?.getInspectionTeacherData;
        this.getInspectionTeacherAbsentData = res?.getInspectionTeacherAbsentData;
        this.getInspectionQuestion = res?.getInspectionQuestion;
        this.spinner.hide();
      },
      error: (error: any) => {
        this.isLoading = false;

...
@Component({
  selector: 'app-remedial-tranning-report',
  templateUrl: './remedial-tranning-report.component.html',
  styleUrls: ['./remedial-tranning-report.component.css']
})
export class RemedialTranningReportComponent implements OnInit {
  optionVal:any;
  optionstream:any;
  ...
  loadData(params: any){
    ...
    this.isLoading = true;
    this.studentMisService.getRemedialReport(paramObj).subscribe({
      next: (res: any) => {
  ...
  getAllClass(){
    ...
    this.studentMisService.getAllClass().subscribe((res:any)=>{

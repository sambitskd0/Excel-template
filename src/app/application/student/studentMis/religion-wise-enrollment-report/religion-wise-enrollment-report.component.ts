...
@Component({
  selector: 'app-religion-wise-enrollment-report',
  templateUrl: './religion-wise-enrollment-report.component.html',
  styleUrls: ['./religion-wise-enrollment-report.component.css']
})
export class ReligionWiseEnrollmentReportComponent implements OnInit {
  optionVal:any;
  optionstream:any;
  ...
  csvData:any;
  className:any = "";
  allOthersStuTotal: any;
  allChristianStuTotal: any;
  allSikhStuTotal: any;
  allIslamStuTotal: any;
  allHinduStuTotal: any;
  allStuTotal: any;
  ...
  loadData(params: any){
    ...
    this.isLoading = true;
    this.studentMisService.getReligionWiseReport(paramObj).subscribe({
      next: (res: any) => {
        this.resultListData = res?.data; // merge with existing data
        this.allStuTotal = res?.allStuTotal;
        //this.allClass = res?.allClass;
        this.allHinduStuTotal = res?.allHinduStuTotal;
        this.allIslamStuTotal = res?.allIslamStuTotal;
        this.allSikhStuTotal = res?.allSikhStuTotal;
        this.allChristianStuTotal = res?.allChristianStuTotal;
        this.allOthersStuTotal = res?.allOthersStuTotal;

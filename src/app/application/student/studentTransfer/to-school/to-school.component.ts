...
@Component({
  selector: 'app-to-school',
  templateUrl: './to-school.component.html',
  styleUrls: ['./to-school.component.css']
})
export class ToSchoolComponent implements OnInit {
...
/** mat table ::end */
  ...
  loadData(...params: any) {
    ...
    this.studentServices.toSchoolTransferList(this.paramObj).subscribe({
      next: (res: any) => {
  ...
  getSearchParams() {
    return {
      ...
      // group: this.group,
      // section: this.section,
      certificateNo: this.searchForm?.get("certificateNo")?.value,

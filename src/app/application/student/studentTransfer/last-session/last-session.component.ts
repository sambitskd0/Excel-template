...
@Component({
  ...
  styleUrls: ['./last-session.component.css']
})
...
/** mat table ::end */
  ...
  loadData(...params: any) {
    ...
    this.studentServices.lastSessionTransferList(this.paramObj).subscribe({
      next: (res: any) => {
  ...
  getSearchParams() {
    return {
      ...
      studentName: this.searchForm?.get("studentName")?.value,

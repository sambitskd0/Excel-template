...
@Component({
  selector: 'app-view-eventcategory',
  templateUrl: './view-eventcategory.component.html',
  styleUrls: ['./view-eventcategory.component.css']
})
export class ViewEventcategoryComponent implements OnInit {
  public fileUrl = environment.filePath;
  EventCategorySearchForm!: FormGroup;
   resData:any;
  eventType: any ="";
  description: any ="";
  categoryName:any ="";
  ...
  constructor(private manageeventcategoryservice:ManageEventCategoryService,
  ...
  ngOnInit(): void {
    ...
    if(this.plPrivilege=='admin'){
     ...
     this.loadEventCategory(this.getSearchParams());
}
ngAfterViewInit() {
     ...
     loadEventCategory(...params: any)
      {
        ...
        this.isLoading = true;
        this.manageeventcategoryservice.viewEventCategory(this.paramObj).subscribe({
          next: (res: any) => {
    ...
    .then((result) => {
      if (result.value) {
        ...
        this.manageeventcategoryservice
          .deleteEventCategory(id, this.userId,this.profileId)
          .subscribe({
            next: (res: any) => {
              if (res?.success === true) {

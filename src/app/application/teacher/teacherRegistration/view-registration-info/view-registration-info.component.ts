...
@Component({
  selector: 'app-view-registration-info',
  templateUrl: './view-registration-info.component.html',
  styleUrls: ['./view-registration-info.component.css']
})
export class ViewRegistrationInfoComponent implements OnInit {

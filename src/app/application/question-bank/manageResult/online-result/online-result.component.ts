...
@Component({
  ...
  templateUrl: "./online-result.component.html",
  styleUrls: ["./online-result.component.css"],
})
export class OnlineResultComponent implements OnInit {
  // mat table
  ...
  loadData(...params: any) {
    ...
    this.questionBankService.getOnlineResult(this.paramObj).subscribe({
      next: (res: any) => {
  ...
  downloadOnlineAssessmentResultList() {
    this.spinner.show();
